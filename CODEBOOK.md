...
For the Run_Analyss tidy dataset, the mean and standard deviation were included
for each feature as described below:
...
For the Run_Analyss tidy dataset, the following variables were NOT INCLUDED
for each feature:
